 ...
 */
final class Version20190711223944 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE notification ADD url VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE is_read is_read TINYINT(1) DEFAULT \'NULL\'');
