 ...
 */
final class Version20190711145543 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE notification ADD created_at DATETIME NOT NULL, CHANGE is_read is_read TINYINT(1) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE notification DROP created_at, CHANGE is_read is_read TINYINT(1) DEFAULT \'NULL\'');
