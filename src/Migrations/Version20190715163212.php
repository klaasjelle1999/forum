 ...
 */
final class Version20190715163212 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE notification ADD path VARCHAR(255) DEFAULT NULL, CHANGE is_read is_read TINYINT(1) DEFAULT NULL, CHANGE status status VARCHAR(64) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE notification DROP path, CHANGE is_read is_read TINYINT(1) DEFAULT \'NULL\', CHANGE status status VARCHAR(64) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
