 ...
 */
final class Version20190715160554 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE notification ADD status VARCHAR(64) DEFAULT NULL, CHANGE is_read is_read TINYINT(1) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE notification DROP status, CHANGE is_read is_read TINYINT(1) DEFAULT \'NULL\'');
